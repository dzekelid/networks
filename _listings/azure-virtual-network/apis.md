...
- name: Azure Virtual Network API Virtual Networks Check IPAddress Availability
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/networks/master/_listings/azure-virtual-network/subscriptions-subscriptionid-resourcegroups-resourcegroupname-providers-microsoft-network-virtualnetworks-virtualnetworkname-checkipaddressavailability-get-postman.md
x-common:
