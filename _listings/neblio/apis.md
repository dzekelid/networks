...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/networks/master/_listings/neblio/apis.md
...
- name: Neblio REST API Suite - Broadcasts a signed raw transaction to the network
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/networks/master/_listings/neblio/testnetntp1broadcast-post-openapi.md
- name: Neblio REST API Suite - Broadcasts a signed raw transaction to the network
    (not NTP1 specific)
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/networks/master/_listings/neblio/testnetinstxsend-post-openapi.md
- name: Neblio REST API Suite - Broadcasts a signed raw transaction to the network
    (not NTP1 specific)
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/networks/master/_listings/neblio/instxsend-post-openapi.md
- name: Neblio REST API Suite - Broadcasts a signed raw transaction to the network
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/networks/master/_listings/neblio/ntp1broadcast-post-openapi.md
x-common:
- type: x-blog-rss
